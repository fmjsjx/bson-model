...
public class TestModel {
    ...
    public void testBasic() {
        ...
        var json = """
                {"uid":1,"basicInfo":{"name":"test","avatar":"","lastLoginAt":${now},"gis":{"longitude":121.569894,"latitude":31.251832},"birthday":"2000-01-23"},"wallet":{"coinTotal":100,"coin":100,"diamond":0,"ad":0},"equipments":{"${equipment.id}":{"id":"${equipment.id}","refId":1,"atk":10,"def":0,"hp":0,"extension":{"key1":"value1"}}},"items":{"1001":3,"2001":1},"createdAt":${now},"updatedAt":${now}}""";
        ...
        var storeJson = """
                {"_id":1,"bi":{"n":"test","a":"","llt":${now},"g":{"lo":121.569894,"la":31.251832},"b":20000123},"w":{"ct":100,"cu":0,"d":0,"ad":0},"e":{"${equipment.id}":{"i":"${equipment.id}","ri":1,"a":10,"d":0,"h":0,"ex":{"key1":"value1"}}},"i":{"1001":3,"2001":1},"_uv":0,"_ct":${now},"_ut":${now}}""";
    ...
    public void testToUpdates() {
        ...
        assertEquals(Updates.set("bi.b", 2000_01_23), updates.get(5));
        assertEquals(Updates.set("w.ct", 100L), updates.get(6));
        assertEquals(
                Updates.set(
                        "e." + equipment.getId(),
                        new BsonDocument("i", new BsonString(equipment.getId()))
                ...
                updates.get(7));
        assertEquals(Updates.set("i.1001", new BsonInt32(3)), updates.get(8));
        assertEquals(Updates.set("i.2001", new BsonInt32(1)), updates.get(9));
        assertEquals(Updates.set("_ct", new BsonDateTime(DateTimeUtil.toEpochMilli(player.getCreateTime()))), updates.get(10));
        assertEquals(Updates.set("_ut", new BsonDateTime(DateTimeUtil.toEpochMilli(player.getCreateTime()))), updates.get(11));
